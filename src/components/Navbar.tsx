    ...
    <nav className="bg-islanema-blue text-white py-4 px-6 sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <Link to="/apply" className="hover:text-islanema-gold transition-colors">Apply</Link>
        </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-islanema-blue py-4 px-6 shadow-md animate-fade-in">
          <div className="flex flex-col space-y-3">
            ...
            <Link to="/apply" className="hover:text-islanema-gold transition-colors" onClick={() => setIsMenuOpen(false)}>
              Apply
            </Link>
            <Button 
